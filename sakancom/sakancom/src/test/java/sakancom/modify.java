...
//	    throw new io.cucumber.java.PendingException();
	...
	public void the_residence_id_changed() {
		 ...
		 assertTrue(Main.editHousing2(1,2200,2));
}
...
//	    throw new io.cucumber.java.PendingException();
	...
	public void the_residence_name_changed() {
			 ...
			 assertTrue(Main.editHousing1(2,2200,"Safa 2"));
}
	...
	public void the_location_changed() {
	 assertTrue(Main.editHousing1(3,2200,"Ramallah"));
}
	...
	public void the_floor_number_changed() {
	 assertTrue(Main.editHousing2(4,2200,8));
}
	...
	public void the_apartment_number_changed() {
	 assertTrue(Main.editHousing2(5,2200,5));
}
	...
	public void the_photo_changed() {
	 assertTrue(Main.editHousing1(6,25,"https://www.google.com/search?sxsrf=AB5stBhHbiE2tsPqSjSpPMz0nf1Bh5x98Q:1690545349904&q=%D8%B4%D9%82%D8%A9&tbm=isch&source=lnms&sa=X&ved=2ahUKEwic5rqYrLGAAxVE66QKHQCeD9MQ0pQJegQIDRAB&biw=707&bih=642&dpr=1.38#imgrc=tgKsaeU4RfW7pM"));
}
	...
	public void the_rent_changed() {
	 assertTrue(Main.editHousing2(7,25,1800));
}
	...
	public void the_services_changed() {
		 ...
		 assertTrue(Main.editHousing1(8,25,"Enter_net"));
}
	...
	public void the_max_number_of_tenant_changed() {
	 assertTrue(Main.editHousing2(9,25,3));
}
	...
	public void the_number_of_bedrooms_changed() {
	 assertTrue(Main.editHousing2(10,25,3));
}
	...
	public void the_number_of_bathrooms_changed() {
	 assertTrue(Main.editHousing2(11,25,2));
	}
	...
	public void the_balcony_changed() {
		 assertTrue(Main.editHousing2(12,25,0));
}
	...
	public void the_owner_name_changed() {
		 assertTrue(Main.editHousing1(13,25,"Ahmad Sami"));
	}
	...
	public void the_owner_phone_changed() {
		 assertTrue(Main.editHousing1(14,25,"0599554455"));
}
	...
	public void the_owner_email_changed() {
		 assertTrue(Main.editHousing1(15,25,"AhmadSami@gmail.com"));
	}
